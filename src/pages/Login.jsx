...
function Login({ setUser }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_DESTINATIONS_API_URL}/auth/signin`, {
        email,
        password
      });
      ...
      setError(error.response?.data?.message || 'Error al iniciar sesión. Por favor intenta nuevamente.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-8 text-center">
            <h1 className="text-2xl font-bold text-white">Bienvenido a Interurban</h1>
            <p className="text-blue-100 mt-2">Ingresa tus credenciales para continuar</p>
          </div>
